    ...
    presxml = <<~OUTPUT
       <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
         <bibdata>
           ...
           <status>
             <stage abbreviation="IS" language="">60</stage>
             <stage abbreviation="IS" language="ja">国際規格</stage>
           </status>
         ...
         <sections>
           <p class="JapaneseIndustrialStandard" displayorder="3">日本産業規格<tab/><tab/><tab/><tab/><tab/><tab/><tab/><span class="JIS">JIS</span></p>
           ...
           <clause id="D" obligation="normative" type="scope" displayorder="11">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="D">1</semx></fmt-xref-label>
             <p id="E">Text</p>
           </clause>
           <clause id="H" obligation="normative" displayorder="13">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="H">3</semx></fmt-xref-label>
             <terms id="I" obligation="normative">
           ...
           <definitions id="L" displayorder="14">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="L">4</semx></fmt-xref-label>
             <dl>
               <dt>Symbol</dt>
               <dd>Definition</dd>
             </dl>
           ...
           <clause id="M" inline-header="false" obligation="normative" displayorder="15">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="M">5</semx></fmt-xref-label>
             <clause id="N" inline-header="false" obligation="normative">
               <title id="_">Introduction</title>
               <fmt-title depth="2" id="_">
                 <span class="fmt-caption-label">
           ...
           <references id="R" normative="true" obligation="informative" displayorder="12">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="R">2</semx></fmt-xref-label>
           </references>
         </sections>
         <annex id="P" inline-header="false" obligation="normative" autonum="A" displayorder="16">
           <title id="_">Annex</title>
           <fmt-title id="_">
             <span class="fmt-caption-label"><span class="fmt-element-name">附属書</span> <semx element="autonum" source="P">A</semx></span>
             <br/>
           ...
           <fmt-xref-label><span class="fmt-element-name">附属書</span> <semx element="autonum" source="P">A</semx></fmt-xref-label>
           ...
           <appendix id="Q2" inline-header="false" obligation="normative" autonum="1">
             ...
             <fmt-title depth="2" id="_">
               <span class="fmt-caption-label"><span class="fmt-element-name">付録</span> <semx element="autonum" source="Q2">1</semx></span>
               <span class="fmt-caption-delim">
                 <tab/>
               </span>
               <semx element="title" source="_">An Appendix</semx>
             </fmt-title>
             <fmt-xref-label><span class="fmt-element-name">付録</span> <semx element="autonum" source="Q2">1</semx></fmt-xref-label>
             <fmt-xref-label container="P"><span class="fmt-xref-container"><span class="fmt-element-name">附属書</span> <semx element="autonum" source="P">A</semx></span><span class="fmt-conn">の</span><span class="fmt-element-name">付録</span> <semx element="autonum" source="Q2">1</semx></fmt-xref-label>
           </appendix>
         </annex>
         <bibliography>
      ...
      <html lang="ja">
         ...
         <body lang="ja">
            ...
            <div class="main-section">
               ...
               <p class="JapaneseIndustrialStandard">日本産業規格#{'　　　　　　　'}<span class="JIS">JIS</span></p>
         ...
         <head>
           ...
           <style></style>
            ...
            <div class="WordSection3">
               <p class="JapaneseIndustrialStandard">日本産業規格<span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span style="mso-tab-count:1">  </span><span class="JIS">JIS</span></p>
            ...
            <p style="display:none;" class="variant-title-toc">附属書 A<span style="mso-tab-count:1">  </span>Annex</p>
                  ...
                  <div id="Q2">
                     <h2>付録 1<span style="mso-tab-count:1">  </span>An Appendix</h2>
                  </div>
               </div>
               <p class="page-break">
                  <br clear="all" style="mso-special-character:line-break;page-break-before:always"/>
       ...
       <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
         ...
         <annex id="P" inline-header="false" obligation="normative" autonum="A" displayorder="16">
           ...
           <appendix id="Q2" inline-header="false" obligation="normative" autonum="一">
             ...
             <fmt-title depth="2" id="_">
               <span class="fmt-caption-label">
                 <span class="fmt-element-name">付録</span>
             ...
             <fmt-xref-label container="P">
               <span class="fmt-xref-container"><span class="fmt-element-name">附属書</span> <semx element="autonum" source="P">A</semx></span>
  ...
  it "defaults to Japanese" do
    ...
    output = <<~OUTPUT
      ...
      #{'          '}
            ...
            <semx element="title" source="_">First Annex</semx>
         </variant-title>
            </annex>
         </sections>
      </iso-standard>
    ...
    output = <<~OUTPUT
      <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
        <bibdata>
          <language current="true">ja</language>
          <edition language="">2.1</edition>
          <edition language="ja">第2.1版</edition>
        </bibdata>
      </iso-standard>
    OUTPUT
    expect(strip_guid(IsoDoc::Jis::PresentationXMLConvert
