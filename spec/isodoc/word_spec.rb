...
RSpec.describe IsoDoc::Jis do
  it "processes Word styles" do
    input = <<~INPUT
      ...
      <fmt-title id="_">まえがき</fmt-title>
      <p id="_553c5ce1-fd17-941b-b935-59caca87f267">This is a foreword</p>
      </foreword>
      <clause type="toc"><fmt-title id="_">目次</fmt-title></clause>
      </preface><sections>
      <clause id="_clause" inline-header="false" obligation="normative" displayorder="3">
      <fmt-title id="_" depth="1">2<tab/>Clause</fmt-title>
      <note id="_339b7abc-c95c-638c-54a9-750cef9ea065"><fmt-name id="_">注記<tab/></fmt-name><p id="_977f50de-4e2f-4dfc-c48b-c35a3ff271cc">Para1</p>
      ...
      <fmt-title id="_" depth="1">1<tab/>引用規格</fmt-title><p id="_375d89b0-e764-77b0-b84e-611678e3e3a8">次に掲げる引用規格は，この規格に引用されることによ>って
      ...
      <annex id="A" displayorder="4"><fmt-title id="_">Annex</fmt-title>
      <clause id="B"><fmt-title id="_">Annex Clause</fmt-title>
      <clause id="C"><fmt-title id="_">Annex Clause Clause</fmt-title>
      </clause></clause></annex>
      <bibliography>
      <references id="_bibliography" normative="false" obligation="informative" displayorder="6">
      <fmt-title id="_" depth="1">参考文献</fmt-title>
  ...
  it "moves content to inner cover" do
    input = <<~INPUT
      ...
      <preface>
      <foreword displayorder="1"><fmt-title id="_">Antauparolo</fmt-title></foreword>
      <clause type="participants" displayorder="3"><fmt-title id="_">Contributors</fmt-title><p>Contributors</p></clause>
      </preface>
      </jis-standard>
    INPUT
    FileUtils.rm_f "test.doc"
